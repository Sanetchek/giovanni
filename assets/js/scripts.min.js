jQuery(document).ready(function(n){let r=setInterval(function(){var e,t,o,i,s=n(".wc-block-checkout__terms"),a=n(".wc-block-components-checkout-place-order-button");s.length&&a.length&&(clearInterval(r),e=n("<div>",{class:"wc-block-components-checkbox"}),i=n("<input>",{id:"terms",type:"checkbox",class:"wc-block-components-checkbox__input",name:"terms",required:!0,"aria-invalid":"false"}),t=n(`
